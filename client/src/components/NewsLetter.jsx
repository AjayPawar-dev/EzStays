...
const NewsLetter = () => {
    ...
    return (
        <div className="flex flex-col items-center max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col md:flex-row items-center justify-center gap-4 mt-6 w-full">
                <input 
                    type="email" 
                    required     
                    className="bg-white/10 px-4 py-2.5 border border-white/20 rounded outline-none max-w-66 w-full focus:border-white/50 transition-all" 
