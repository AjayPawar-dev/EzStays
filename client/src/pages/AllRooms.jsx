...
const AllRooms = () => {
    ...
    return (
        <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                    ...
                    {roomsDummyData.map((room) => (
                        <div key={room._id} className='flex flex-col md:flex-row items-start py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0'>
                            ...
                            <div className='md:w-1/2 flex flex-col gap-2'>
                                ...
                                <p onClick={() => { navigate(`/rooms/${room._id}`); window.scrollTo(0, 0) }} className='text-gray-800 text-3xl font-playfair cursor-pointer'>
                                    {room.hotel.name}
                                </p>
                                ...
                                <div className='flex flex-wrap items-center mb-6 gap-4 mt-3'>
                                    {room.amenities.map((item, index) => (
                                        <div key={index} className='flex items-center px-3 py-2 rounded-lg gap-2 bg-[#F5F5FF]/70'>
            ...
            <div className='bg-white border border-gray-300 w-80 text-gray-600 lg:mt-16  max-lg:mb-8 '>

                <div className={`flex items-center justify-between px-5 py-2.5 lg:border-b border-gray-300 ${openFilters && "border-b"}`}>
                    <p className='text-base font-medium text-gray-800'>Filter By</p>
